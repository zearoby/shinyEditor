# define server logic required to generate simple monaco editor
shinyServer(function(input, output, session) {
   ...
   shiny::observeEvent(input$appendCompleter, {
      shinyEditor::appendMonacoCompleter(
   ...
   shiny::observeEvent(input$removeCompleter, {
      shinyEditor::removeMonacoCompleter(output_id, id = "custom_completer")
   })

   shiny::observeEvent(input$enableSpellCheck, {
      shinyEditor::setMonacoEnableSpellCheck(output_id, enable = TRUE)
   })
   shiny::observeEvent(input$disableSpellCheck, {
      shinyEditor::setMonacoEnableSpellCheck(output_id, enable = FALSE)
   })
   shiny::observeEvent(input$lighttheme, {
      shinyEditor::setMonacoTheme("vs")
   })
   shiny::observeEvent(input$darktheme, {
